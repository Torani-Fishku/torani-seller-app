...
@Composable
fun BottomSheetChangeStock(
    moreSheetScope: CoroutineScope,
    moreSheetState: SheetState,
    fishProduct: MenuModel,
    //TODO: implement function for change stock
) {
    var text by rememberSaveable { mutableStateOf("${fishProduct.stock ?: 0}") }
